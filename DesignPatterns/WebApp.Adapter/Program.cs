...
builder.Services.AddScoped<IImageProcess, AdvanceImageProcessAdapter>(); // IImageProcess arayüzüne karşılık gelen AdvanceImageProcessAdapter sınıfı kullanılacak. Adaptör tasarım deseni sayesinde IImageProcess arayüzüne karşılık gelen AdvanceImageProcessAdapter sınıfı kullanılır
