...
namespace WebApp.Decorator.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        {
            var userId = User.Claims.First(x => x.Type == ClaimTypes.NameIdentifier).Value; // Get the user id from the claims
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Stock,UserId")] Product product) // Bind sayesinde sadece bu propertylerin güncellenmesine izin veriyoruz.
        {
            if (id != product.Id)
            {
                return NotFound();
