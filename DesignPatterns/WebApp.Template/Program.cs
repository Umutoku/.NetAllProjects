...
{
    userManager.CreateAsync(new AppUser() {UserName = "admin", Email = "admin@outlook.com",PictureUrl ="",Description=""},"Pass1234!").Wait();
    userManager.CreateAsync(new AppUser() { UserName = "user", Email = "user@outlook.com",PictureUrl = "" , Description = "" }, "Pass1234!").Wait();
    userManager.CreateAsync(new AppUser() { UserName = "user2", Email = "user2@outlook.com", PictureUrl = "" , Description = "" }, "Pass1234!").Wait();
