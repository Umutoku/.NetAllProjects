...
{
    public class ProductsCategoriesControllerTestSQLLite : ProductsCategoriesControllerTest
    {
       
        public ProductsCategoriesControllerTestSQLLite()
        {
            SetContextOptions(ContextOptions);
        }

        public static DbContextOptions<UdemyUnitTestDBContext> ContextOptions
        {
            get
            {
