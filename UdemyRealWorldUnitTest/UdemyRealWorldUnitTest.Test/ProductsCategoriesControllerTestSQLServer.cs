...
{
    public class ProductsCategoriesControllerTestSQLServer : ProductsCategoriesControllerTest
    {
        public ProductsCategoriesControllerTestSQLServer()
        {
